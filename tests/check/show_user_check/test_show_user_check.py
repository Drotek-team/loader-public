...
from loader.show_env.show_user.show_user import DroneUser, PositionEventUser
...
def test_empty_position_events() -> None:
...
def test_valid_one_position_events() -> None:
...
def test_invalid_by_time_one_position_events() -> None:
    one_position_events_drone_user = DroneUser(
        index=0,
...
def test_apply_minimal_position_events_number_check_1_events() -> None:
    one_position_events_drone_user = DroneUser(
        index=0,
        position_events=[PositionEventUser(frame=1, xyz=(2.0, 2.0, 0.0))],
        color_events=[],
...
def test_apply_minimal_position_events_number_check_2_events() -> None:
    one_position_events_drone_user = DroneUser(
        index=0,
        position_events=[
