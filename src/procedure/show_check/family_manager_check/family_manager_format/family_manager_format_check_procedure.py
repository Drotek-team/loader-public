...
def apply_family_manager_format_check(
    ...
    family_manager_format_check_report.nbx_format_check_report.validation = isinstance(
        family_manager.nb_x, int
    )
    family_manager_format_check_report.nby_format_check_report.validation = isinstance(
