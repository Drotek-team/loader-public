...
def test_ijg_to_su_procedure():
    # TODO Not ideal to test the import with the export but it is kind of impossible to visualize unitary binary data
    show_user = get_valid_show_user(ShowUserConfiguration(nb_y=2, step_takeoff=2.0))
